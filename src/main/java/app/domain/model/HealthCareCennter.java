...
public class HealthCareCennter extends VaccinationCenter {
    /**
     * the center address
     */
     ...
     */
    public HealthCareCennter(String name, String address, int phone, String mail, int fax, String website, int opening_hours, int closing_hours, int slot_duration, int max_number_per_slot) {
